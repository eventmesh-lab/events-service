...
namespace eventsservice.Infrastructure.Migrations
{
    ...
    [Migration("20260115214752_AddCancellationAndReschedulingFields")]
    partial class AddCancellationAndReschedulingFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("events_service.Infrastructure.Persistence.EventoEntity", b =>
                {
                    ...
                    b.Property<int>("ContadorReprogramaciones")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateTime?>("FechaInicioOriginal")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<string>("FolletoBlobName")
                        .HasMaxLength(400)
                        .HasColumnType("character varying(400)")
                        .HasColumnName("folleto_blob");

                    b.Property<string>("FolletoContentType")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("folleto_content_type");

                    b.Property<long?>("FolletoSizeBytes")
                        .HasColumnType("bigint")
                        .HasColumnName("folleto_size_bytes");

                    b.Property<string>("ImagenPrincipalBlobName")
                        .HasMaxLength(400)
                        .HasColumnType("character varying(400)")
                        .HasColumnName("imagen_principal_blob");

                    b.Property<string>("ImagenPrincipalContentType")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("imagen_principal_content_type");

                    b.Property<long?>("ImagenPrincipalSizeBytes")
                        .HasColumnType("bigint")
                        .HasColumnName("imagen_principal_size_bytes");

                    b.Property<string>("ImagenesSecundariasJson")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.Property<DateTime?>("UltimaReprogramacionFecha")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("ultima_reprogramacion_fecha");

                    b.Property<string>("UltimaReprogramacionPor")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
